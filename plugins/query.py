...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            InlineKeyboardButton('ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ', 'autofilter'),
            InlineKeyboardButton('ᴍᴀɴᴜᴀʟ ꜰɪʟᴛᴇʀ', 'manuelfilter')
            ],[
            InlineKeyboardButton('ɢʟᴏʙᴀʟ ꜰɪʟᴛᴇʀ', 'globalfilter'),
            InlineKeyboardButton('« ʙᴀᴄᴋ', 'help')           
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴜᴛᴛᴏɴ ꜰᴏʀᴍᴀᴛ', 'button'),
            InlineKeyboardButton('« ʙᴀᴄᴋ', 'openfilter')           
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴜᴛᴛᴏɴ ꜰᴏʀᴍᴀᴛ', 'buttong'),
            InlineKeyboardButton('« ʙᴀᴄᴋ', 'openfilter')           
        ]]
        if query.from_user.id not in ADMINS:
            return await query.answer("ꜱᴏʀʀʏ ᴛʜɪs ᴍᴇɴᴜ ᴏɴʟʏ ꜰᴏʀ ᴍʏ ᴀᴅᴍɪɴs", show_alert=True)
        ...
        buttons = [[
            InlineKeyboardButton('ᴄʟʟᴏꜱᴇ', 'close_data'),
        ...
        buttons = [[
            InlineKeyboardButton('♻️ ʀᴇꜰʀᴇꜱʜ', 'stats'),
            InlineKeyboardButton('« ʙᴀᴄᴋ', 'help')           
        ]]
